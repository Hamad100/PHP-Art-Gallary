...
<?php include("partial/indexpagenav.php"); ?>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-sm-12 test">
                <div class="col-xs-12 one t1">
                    <?php echo "<a href=\"\" data-target=\"#mylogin\" data-toggle=\"modal\"><img src=\"images/painting2.jpg\"></a>"; ?>
            ...
            <div class="col-md-4 col-sm-6 col-sm-12 test">
                <div class="col-xs-12 one t2">
                    <?php echo "<a href=\"\" data-target=\"#mylogin\" data-toggle=\"modal\"><img src=\"images/sculp4.jpg\"></a>"; ?>
            ...
            <div class="col-md-4 col-sm-6 col-sm-12 test">
                <div class="col-xs-12 one t3">
                    <?php echo "<a href=\"\" data-target=\"#mylogin\" data-toggle=\"modal\"><img src=\"images/photo1.jpg\"></a>"; ?>
